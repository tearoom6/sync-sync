      ...
      <div className="sync-sync native-key-bindings">
        ...
        <form>
          ...
          <QiitaTeamSectionView
            ...
            configDirPath={this.props.configDirPath}
            optionKeepFilePath={this.props.optionKeepFilePath}
            qiitaTeamAccessToken={this.props.qiitaTeamAccessToken}
            qiitaTeamTeamId={this.props.qiitaTeamTeamId}
            qiitaTeamUserName={this.props.qiitaTeamUserName}
            qiitaTeamTitle={this.props.qiitaTeamTitle}
            qiitaTeamTags={this.props.qiitaTeamTags}
            qiitaTeamItemUrl={this.props.qiitaTeamItemUrl}
            qiitaTeamGroupId={this.props.qiitaTeamGroupId}
            qiitaTeamCoediting={this.props.qiitaTeamCoediting}
          />
          ...
          <WordpressComSectionView
            ...
            configDirPath={this.props.configDirPath}
            optionKeepFilePath={this.props.optionKeepFilePath}
            wordpressComSite={this.props.wordpressComSite}
            wordpressComAccessToken={this.props.wordpressComAccessToken}
            wordpressComTitle={this.props.wordpressComTitle}
            wordpressComTags={this.props.wordpressComTags}
            wordpressComCategories={this.props.wordpressComCategories}
            wordpressComItemUrl={this.props.wordpressComItemUrl}
          />
          ...
          <WordpressOrgSectionView
            ...
            configDirPath={this.props.configDirPath}
            optionKeepFilePath={this.props.optionKeepFilePath}
            wordpressOrgBaseUrl={this.props.wordpressOrgBaseUrl}
            wordpressOrgAccessToken={this.props.wordpressOrgAccessToken}
            wordpressOrgTitle={this.props.wordpressOrgTitle}
            wordpressOrgTags={this.props.wordpressOrgTags}
            wordpressOrgCategories={this.props.wordpressOrgCategories}
            wordpressOrgItemUrl={this.props.wordpressOrgItemUrl}
          />
          ...
          <HatenaSectionView
            ...
            configDirPath={this.props.configDirPath}
            optionKeepFilePath={this.props.optionKeepFilePath}
            hatenaApiKey={this.props.hatenaApiKey}
            hatenaUserId={this.props.hatenaUserId}
            hatenaBlogId={this.props.hatenaBlogId}
            hatenaTitle={this.props.hatenaTitle}
            hatenaCategories={this.props.hatenaCategories}
            hatenaItemUrl={this.props.hatenaItemUrl}
          />
          ...
          <BloggerSectionView
            ...
            configDirPath={this.props.configDirPath}
            optionKeepFilePath={this.props.optionKeepFilePath}
            bloggerApiKey={this.props.bloggerApiKey}
            bloggerBlogId={this.props.bloggerBlogId}
            bloggerTitle={this.props.bloggerTitle}
            bloggerLabels={this.props.bloggerLabels}
            bloggerItemUrl={this.props.bloggerItemUrl}
          />
          ...
          <MediumSectionView
            ...
            configDirPath={this.props.configDirPath}
            optionKeepFilePath={this.props.optionKeepFilePath}
            mediumAccessToken={this.props.mediumAccessToken}
            mediumTitle={this.props.mediumTitle}
            mediumTags={this.props.mediumTags}
            mediumStatus={this.props.mediumStatus}
            mediumItemUrl={this.props.mediumItemUrl}
          />
