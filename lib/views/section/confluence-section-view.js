...
export default class ConfluenceSectionView extends SectionViewBase {
  ...
  static resolveConfluenceItemPath(localPath, configPath, item, currentItem, optionKeepFilePath, flatImport) {
    ...
    return `${localPath}/${parentsDir}/${this.escapeFileName(item.title)}.html`
  }
}
