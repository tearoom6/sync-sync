    ...
    return (
      ...
      <div className="sync-sync native-key-bindings modal">
        ...
        <label htmlFor="origin-path">
          <span>Origin</span>
          <input type="text" id="origin-path" ref="originPath" value={this.props.originPath || ''} readOnly />
        </label>
        <br />

        <label htmlFor="destination-path">
          <span>Destination</span>
          <input type="text" id="destination-path" ref="destinationPath" value={this.props.destinationPath || ''} />
        </label>
        <br />
